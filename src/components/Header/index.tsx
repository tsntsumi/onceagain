                        ...
                        <li key={index} className="group relative">
                          {pathUrl !== "/" ? (
                            <Link
                              ...
                              scroll={false}
                              href={menuItem.path}
                              className={`ud-menu-scroll flex flex-nowrap whitespace-nowrap py-2 text-base text-dark group-hover:text-primary dark:text-white dark:group-hover:text-primary lg:inline-flex lg:px-0 lg:py-6 ${
                ...
                {session?.user ? (
                  <>
                    ...
                    {pathUrl !== "/" || sticky ? (
                      <button
                        onClick={() => signOut()}
                        className="signUpBtn rounded-lg bg-secondary bg-opacity-100 px-6 py-3 text-base font-medium text-dark duration-300 ease-in-out hover:bg-opacity-20 hover:text-dark"
                      >
                        サインアウト
                      </button>
                    ) : (
