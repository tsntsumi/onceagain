        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          ...
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              ...
              answer="企業がAIを活用して業務プロセスを自動化する際の戦略立案や実装を支援する
                        専門機関を指します。<br/>
                        【AIエージェンシーのベネフィット】: クライアントのビジネス成長に貢献できるため、
                        長期的なパートナーシップを構築しやすくなります。"
            />
            <SingleFaq
              question="AIオートメーションエージェンシーの提供するサービスは何ですか？"
              answer="回答: 業務プロセスの分析、AIソリューションの設計・開発、導入後のサポートや
                        トレーニングなど、多岐にわたります。<br/>
                        【AIエージェンシーのベネフィット】: サービスの幅を広げることで、
                        継続的な収益モデル（コンサルティング、保守契約など）を構築できます。"
            />
            <SingleFaq
            ...
            <SingleFaq
              ...
              answer="必要なソリューションの内容や規模によって異なります。
                        ...
                        柔軟な料金設定が可能なため、利益率の高いビジネスモデルを構築できます。"
            />
            <SingleFaq
