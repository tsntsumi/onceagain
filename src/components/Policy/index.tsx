            ...
            <div className="w-full px-4 lg:w-1/2">
              <div className="mb-12 max-w-[540px] lg:mb-0 mx-auto">
                ...
                <div>
                  ...
                  <h4>共同利用の目的</h4>
                  <ol className="ml-4 pl-4 -indent-4">
                    <li>
                ...
                <h4>｢開示等の求め｣の申し出先</h4>
                <p>
                  下記宛、所定の申請書に必要書類・手数料を添付の上、EMS で郵送をお願い申し上げます。
                </p>
                <p>
                  なお、封筒に朱書きで「開示等請求書類在中」とお書き添えいただければ幸いです。
                </p>
                <blockquote className="mb-4">
                  Purok 7 Hagad st. Central pob. Casiguran Sorsogon, PHILIPPINES
                  <br />
                  Alexander G. Habla / Alizza Ideal 個人情報保護事務局
                </blockquote>
                ...
                <Link
                  ...
                  className="font-mono mt-0 pt-0 ml-8 underline"
                >
                  &lt;mailto:info+inquiry@alizza-ideal.com&gt;
                </Link>
                <p className="indent-0 mt-8">
                  にて問い合わせください
                </p>
                <h4>代理人による「開示等の求め」</h4>
                <p>
                ...
                <div>
                  <p>
                    ...
                    以下の金額（弊社からの返信のための EMS 書類）を申し受けます。
                  </p>
                </div>
                <h4>開示等の求めに関する手数料：2,000円</h4>
                <p>2,000円を、
                  <Link
                    href="/legal#other"
                    className="font-mono mt-0 pt-0 ml-8 underline"
                  ...
                  ページの
                  「その他について」にしたがって決済してください。。</p>
                <p>
                  手数料が不足していた場合、及び手数料がお支払いされなかった場合は、
                ...
                <ul className="ml-4 pl-4 -indent-4">
                  <li>
                ...
                <p>
                  ...
                  業界で機密保持の標準規格として使用されている SSL (Secure Socket
                  Layer) 暗号化技術を使用しております。
                </p>

                <h3>プライバシーポリシーの変更</h3>
                <p>
                  本プライバシーポリシーの内容は、お客様に通知をすることなく変更されることがあります。
                </p>
                <p>
